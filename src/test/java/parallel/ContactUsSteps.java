...
public class ContactUsSteps {
	...
	public void user_fills_the_form_from_given_sheetname_and_rownumber(String sheetName, Integer rowNumber) throws InvalidFormatException, IOException {
		...
		List<Map<String,String>> testData = 
				reader.getData("C:\\Training_Scripts\\BDD Framework\\Cucumber_Training\\workspace\\Cucumber_Advance_Topics\\src\\test\\resources\\TestData\\ContactUs.xlsx", sheetName);
